...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ background: isDark ? '#0a0e17' : '#f1f5f9' }}>
            ...
            <div className="absolute bottom-0 left-0 w-32 h-32 opacity-20" style={{ borderBottom: '2px solid #047857', borderLeft: '2px solid #047857' }} />
            ...
            >
                <div className="h-[2px] rounded-t-xl" style={{ background: 'linear-gradient(90deg, transparent, #047857, transparent)' }} />
                <div
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button type="submit" disabled={isLoading}
                            ...
                            style={{ background: isLoading ? 'rgba(4,120,87,0.3)' : 'linear-gradient(135deg, #047857 0%, #065f46 100%)', color: '#ffffff', boxShadow: isLoading ? 'none' : '0 0 20px rgba(4,120,87,0.2)' }}>
                            {isLoading ? (
